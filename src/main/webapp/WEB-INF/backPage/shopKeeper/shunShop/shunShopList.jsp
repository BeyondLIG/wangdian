...
<div class="bjui-pageHeader">
    <form id="pagerForm" data-toggle="ajaxsearch" action="${pageContext.request.contextPath}/admin/shopKeeper/shunShop/list" method="post">
    ...
    <table class="table table-bordered table-hover table-striped table-top" data-selected-multi="true">
        ...
        <c:forEach var="list" items="${shunShopList.content}" varStatus="i">
            <tr>
                ...
                <!--
                <td>
                    <a href="${pageContext.request.contextPath}/admin/shopKeeper/shunShop/add?id=${list.id}" class="btn btn-default" data-toggle="dialog" data-width="900" data-height="600" data-id="dialog-mask" data-mask="true">查看详情</a>
                </td>
                -->
            </tr>
        </c:forEach>
